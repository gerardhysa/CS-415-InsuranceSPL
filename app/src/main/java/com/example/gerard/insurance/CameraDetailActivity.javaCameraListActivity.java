...
public class CameraListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View recyclerView = findViewById(R.id.camera_list);
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final CameraListActivity mParentActivity;
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {/*
                    ...
                    arguments.putString(CameraDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    intent.putExtra(CameraDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(CameraListActivity parent,
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.camera_list_content, parent, false);
